...
let menuCt = document.querySelector(".section-center") 
...
`
  ...
  let allFood = document.getElementById("all"); 
  let koreaFood = document.getElementById("korea"); 
  let japanFood = document.getElementById("japan"); 
  let chinaFood = document.getElementById("china");   

  allFood.addEventListener("click", tumYemekler) 
  koreaFood.addEventListener("click", koreYemekleri)  
  japanFood.addEventListener("click", japonYemekleri) 
  chinaFood.addEventListener("click", cinYemekleri) 
...
function tumYemekler() {
  ...
  menuCt.innerHTML = allMenu
} 

// Kore yemekleri 
function koreYemekleri(){
  let allMenu = "" 
  menu.map(menu => { 
